...
#        return output
    ...
    def update(self, word):
        ...
        for letter in new_hand.keys():
            ...
            if new_hand[letter] < 0:        # UWAGA : słownik może mieć wartosci UJEMNE !!!
                return False
...
#        
#        for l in word:
#            wLetters[l] = wLetters.get(l, 0) + 1
#            
#        for letter in wLetters:
#            if letter not in self.hand or wLetters[letter] > self.hand[letter]:
#                return False       
#            else:
#               self.hand[let] -= wLetters[let]
#        
#        return True
